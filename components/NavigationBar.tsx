    ...
    <nav className="sticky top-0 z-50 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm py-3">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between gap-2">
          ...
          {/* Center: Mini Search (only show when main search is out of viewport, hide on mobile) */}
          <div
            className="hidden md:block flex-1 max-w-xs mx-6 transition-all duration-300"
            style={{
