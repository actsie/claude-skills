...
tags: ["skill email html mjml", "framix-team", "skill"]
date: "2026-03-26T11:20:34.387Z"
---
...
**Minify and `<` characters**: With `--config.minify=true`, bare `<` characters inside ending tags cause parse errors. Wrap in `` or escape as `&lt;`.
